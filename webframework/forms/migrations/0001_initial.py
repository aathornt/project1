# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-04-30 19:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('post_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='forms.Post')),
                ('RegistrationFees_ID', models.AutoField(primary_key=True, serialize=False)),
                ('Category', models.CharField(choices=[(b'Conference Fees', b'Conference Fees'), (b'Banquet Fees', b'Banquet Fees'), (b'Dues', b'Dues'), (b'Other', b'Other')], default=b'Conference Fees', max_length=30)),
